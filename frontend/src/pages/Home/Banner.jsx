  ...
  return (
    <div className='flex flex-col md:flex-row-reverse  justify-between items-center gap-12'>
           ...
           <div className='w-full md:w-1/2 '>
                ...
                <button className='px-12 py-2 rounded-md text-base font-secondary font-bold hover:bg-secondary hover:text-white transition-all duration-200 cursor-pointer bg-primary'>Subscribe</button>
           </div>
    </div>
  )
}
